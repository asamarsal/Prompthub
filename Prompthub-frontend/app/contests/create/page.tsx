            ...
            <div className="min-h-screen py-12 px-4 lg:px-8 max-w-3xl mx-auto">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-[#ff2d95]/5 border border-[#ff2d95]/20">
                        ...
                        <p className="text-xs text-white/50">By submitting, you agree that the prize pool will be escrowed via a Stacks smart contract. Funds are released automatically to winners after judging. PromptHub charges a 3% platform fee.</p>
                    </div>
