...
import { Star, BadgeCheck, Zap, Search, SlidersHorizontal } from "lucide-react"
...
export default function HirePage() {
    ...
    const filtered = artists.filter(a => {
        ...
        if (specialty !== "All" && !a.specialties.some(s => s.toLowerCase().includes(specialty.toLowerCase()))) return false
        if (tool !== "All" && !a.tools.some(t => t.toLowerCase().includes(tool.toLowerCase()))) return false
        ...
        <AppShell>
            <div className="min-h-screen py-12 px-4 lg:px-8 max-w-7xl mx-auto">
                ...
                <div className="mb-10">
                    ...
                    <p className="text-[#a78bfa] max-w-xl">Connect with verified AI creators for your brand campaigns, product launches, NFT drops, and more. Powered by sBTC escrow.</p>
                </div>
                ...
                {/* Count */}
                <p className="text-xs text-white/30 font-mono mb-6">{filtered.length} artist{filtered.length !== 1 ? "s" : ""} found</p>
