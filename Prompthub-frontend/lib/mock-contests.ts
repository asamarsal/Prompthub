...
export const contests: Contest[] = [
    ...
    },
    {
        ...
        brand: "StacksBrew Coffee",
        brandLogo: "",
        description: "StacksBrew is the world's first Bitcoin-native coffee brand. We're launching our limited edition sBTC Roast and need campaign visuals that blend coffee culture with Web3 aesthetics.",
    ...
    },
    {
        ...
        brand: "BitFit",
        brandLogo: "",
        description: "BitFit rewards workout streaks with sBTC. We need energetic, motivational social media content that connects fitness with crypto culture.",
        brief: "Create 1 hero social media post (1080×1080) showing the connection between physical achievement and Bitcoin reward. Energetic, vibrant, human-centered.",
        prizePool: 0.15,
        currency: "sBTC",
        prizes: [
        ...
        tags: ["fitness", "bitcoin", "health", "motivation"],
        deadline: "2026-03-18",
        submissionCount: 19,
        status: "judging",
        featured: false,
